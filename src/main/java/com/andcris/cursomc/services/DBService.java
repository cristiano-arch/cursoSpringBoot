...
import com.andcris.cursomc.domain.ItemPedido;
import com.andcris.cursomc.domain.Pagamento;
import com.andcris.cursomc.domain.PagamentoComBoleto;
import com.andcris.cursomc.domain.PagamentoComCartao;
import com.andcris.cursomc.domain.Pedido;
import com.andcris.cursomc.domain.Produto;
import com.andcris.cursomc.domain.enums.EstadoPagamento;
import com.andcris.cursomc.domain.enums.Perfil;
import com.andcris.cursomc.domain.enums.TipoCliente;
import com.andcris.cursomc.repositories.CategoriaRepository;
import com.andcris.cursomc.repositories.CidadeRepository;
...
import com.andcris.cursomc.repositories.ItemPedidoRepository;
import com.andcris.cursomc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "cristianoandre96@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Herbert West", "nevadakid7@gmail.com", "54756123074", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("86397560","12745390"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Reanimator", "2106", null, "Arkham", "25727012", cli2, c2);
