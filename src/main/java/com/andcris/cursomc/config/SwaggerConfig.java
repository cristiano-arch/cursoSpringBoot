package com.andcris.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.andcris.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API replicada por mim, Cristiano André, a partir do curso Spring Boot.",
				"Esta API é utilizada a nível de estudo do curso de Spring Boot do prof. Nelio Alves",
				"Versão 1.0",
